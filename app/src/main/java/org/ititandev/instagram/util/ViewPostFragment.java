...
public class ViewPostFragment extends Fragment {
    ...
    private void init() {
        try {
            String imgURL = BuildConfig.SERVER_URL + "/download/photo/" + getPhotoFromBundle().getImage_path();
                ...
                for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()) {
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (mUsers.toString().contains(mCurrentUser.getUsername() + ",")) {//mitch, mitchell.org
...
//                .setValue(like);
    ...
    private void setupWidgets() {
        ...
        mUsername.setText(getPhotoFromBundle().getName());
    ...
    private String getTimestampDifference() {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat(
                "yyyy-MM-dd'T'HH:mm:ss'Z'", Locale.CANADA);
