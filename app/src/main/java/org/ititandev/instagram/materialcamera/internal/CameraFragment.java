...
import org.ititandev.instagram.materialcamera.util.Degrees;
import org.ititandev.instagram.materialcamera.util.ImageUtil;
import org.ititandev.instagram.materialcamera.util.ManufacturerUtil;

import static org.ititandev.instagram.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static org.ititandev.instagram.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static org.ititandev.instagram.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static org.ititandev.instagram.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static org.ititandev.instagram.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static org.ititandev.instagram.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  org.ititandev.instagram.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new org.ititandev.instagram.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof org.ititandev.instagram.materialcamera.internal.CameraPreview)
